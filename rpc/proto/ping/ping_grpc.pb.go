...
func (c *pingServiceClient) Ping(ctx context.Context, in *PingReq, opts ...grpc.CallOption) (*PingResp, error) {
	out := new(PingResp)
...
func (UnimplementedPingServiceServer) Ping(context.Context, *PingReq) (*PingResp, error) {
